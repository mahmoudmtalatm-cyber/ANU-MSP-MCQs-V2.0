...
function renderIconPickerPop(inputId, filter) {
  ...
  pop.innerHTML = `
    ...
    <div class="icon-picker-add-row">
      ...
      <button onclick="const v=document.getElementById('${inputId}CustomAdd').value.trim(); if(v){ selectIconForField('${inputId}', v); addCustomIcon(v); }"><svg class="sicon" viewBox="0 0 24 24"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg> Add</button>
    </div>`;
